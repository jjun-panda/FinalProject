...
function ListCategoryDesignDev() {
	const category_name = "디자인 & 개발";
	const item_page = 9;
				...
				<div className="navigatorMain">
					<div className="navigatorWrapper">
						...
						<ul className="naviator">
							...
							<li className="menuWrapper">
								<Link className="menu body18x checked" to="/board/list/design_dev">디자인 & 개발</Link>
							</li>
							<li className="menuWrapper">
...
export default ListCategoryDesignDev;